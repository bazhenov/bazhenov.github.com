...
Этот предел говорит нам о том что при растущем `n`, значение выражения <code>(1 - n<sup>-1</sup>)<sup>n</sup></code> стремится к значению <code>e<sup>-1</sup></code>, которое является той самой константой приблизительно равной <code>0.368</code>.
