...
<li>ILP фактор масштабирования суперскалярных процессоров не дает способен дать значимого прироста от поколения к поколению из за зависимостей между инструкциями <span class='missing-note'>[[ILP Wall]]</span>.</li>
<li>медленная память не дает процессорам полностью реализовать вычислительный потенциал <span class='missing-note'>[[Memory Wall]]</span></li>
<li>
...
<li>адаптация парадигм векторизации в вычислениях общего назначения. Это позволит выбирать исполнителя под задачу не меня код программы <span class='missing-note'>[[ILP Wall]]</span></li>
