...
{{< fig "Взаимосвязь классов, классификационных признаков и индикаторов" >}}
...
{{< fig "Классификационная формула метода максимальной энтропии (Формула №1)" >}}
...
{{< fig "Формула расчета энтропии для дискретного вероятностного распределения" >}}
...
{{< fig "График энтропии для монеты с произвольным значением p(H)" >}}
...
{{< fig "Доверительный интервал после трех бросков монеты" >}}
...
{{< fig "Функция условного правдоподобия maxent-классификатора над корпусом документов $(C,D)$" >}}
$$\log p(C|D,\lambda)
...
{{< fig "Визуализация процесса оптимизации произвольной функции двух аргументов (показаны изолинии функции и апроксимационные шаги алгоритма)" >}}
...
{{< fig "Частная производная функции условного правдоподобия" >}} 
$$
