...
![Фасеты на примере amazon.com](/images/search-architecture/amazon-facets.png)
...
![CDF времени ответа для систем с различным количеством партиций](/images/search-architecture/cdf-latency.png)
